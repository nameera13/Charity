...
@section('title','Admin Event Photo')
@section('admin')
    
<section class="section">
    <div class="section-header d-flex justify-content-between">
        <h1>Event ({{ $event->name }}) Photos</h1>
        <div class="">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <h5>Section Items</h5>
                        <form action="{{ url('admin/event-photo') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="event-photo-datatable">
                                <thead>
                                    <tr>
                                        <th>SL</th>
                                        <th>Photo</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#event-photo-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
