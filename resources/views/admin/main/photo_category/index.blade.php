...
@section('title','Admin Photo Category')
@section('admin')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="photo-category-datatable">
                                <thead>
                                    <tr>
                                        <th>SL</th>
                                        <th>Name</th>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#photo-category-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                ...
                columns: [
                    ...
                    {
                        data: 'created_at',
                        name: 'photo_categories.created_at',
                    },
                    {
                        data: null,
                        orderable: false,
