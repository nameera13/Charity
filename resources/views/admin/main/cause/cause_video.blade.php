...
@section('title','Admin Cause Video')
@section('admin')
    
<section class="section">
    <div class="section-header d-flex justify-content-between">
        <h1>Cause ({{ $cause->name }}) Videos</h1>
        <div class="">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <h5>Section Items</h5>
                        <form action="{{ url('admin/cause-video') }}" method="POST" enctype="multipart/form-data">
                            @csrf
